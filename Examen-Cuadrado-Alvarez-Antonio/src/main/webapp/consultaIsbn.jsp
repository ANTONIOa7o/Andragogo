...
<body>
    <div>
        <header>
            <h1 class="titulo" id="navegador">-CONSULTAS-<img src="images/biblioteca-digital.png" width="10%"></h1>
        </header>
        <nav>
            <p> Barra de navegacion</p>
        </nav>
        <section>
            <h2 class="nav-item transicionT titulo2" href="#">Introduce ISBN:</h2><br />
